To run the program you will need to have node.js installed to use the node and npm commands. There are some tutorials online in case you don't have them already.
